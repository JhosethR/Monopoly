...
public class Welcome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JCPlayers.setBackground(new java.awt.Color(204, 255, 0));
        JCPlayers.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        JCPlayers.setForeground(new java.awt.Color(0, 0, 0));
        JCPlayers.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2", "3", "4", "5", "6", "7", "8" }));
        JCPlayers.setOpaque(true);
        JCPlayers.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JCPlayersActionPerformed(evt);
            }
        });
        jPanel1.add(JCPlayers, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 100, 33));
        ...
        jPanel1.add(Start, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 110, 33));

        Exit.setBackground(new java.awt.Color(204, 255, 0));
        ...
        jPanel1.add(Exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 150, 100, 33));
    ...
    private void JCPlayersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JCPlayersActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JCPlayersActionPerformed
